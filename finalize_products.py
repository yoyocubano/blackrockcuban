...
# UPDATE HOODIE
hoodie_id = "69b09a016d2baa18fc0b6ede"
hoodie_update = {
...
print(update_product(hoodie_id, hoodie_update))

# CREATE SHORTS
shorts_data = {
    "title": "Mat Pro Shorts - BRC Athletic",
...
print(create_product(shorts_data))

# CREATE TEE (Blueprint 1382, Provider 29)
tee_data = {
